...
export function initCraft() {
  ...
  // ── MOBILE: horizontal swipe, no pin/scrub ─────────────────────────────────
  // The pinned scroll-scrub feels wrong on phones. On mobile the three panels
  // become a native horizontal scroll-snap row you swipe through — the page
  // scrolls past normally, and the browser owns the swipe (buttery, zero
  // per-frame JS). CSS does the layout via .is-swipe.
  if (isMobile()) {
